...
import (
	...
	"github.com/klaytn/klaytn/core/rawdb"
	"github.com/klaytn/klaytn/crypto"
	"github.com/klaytn/klaytn/ethdb"
...
func (dl *diskLayer) generate(stats *generatorStats) {
	...
	accTrie, err := statedb.NewSecure(dl.root, dl.triedb)
	if err != nil {
	...
	for accIt.Next() {
		...
		if acc.Root != emptyRoot {
			storeTrie, err := statedb.NewSecure(acc.Root, dl.triedb)
			if err != nil {
